...
logo = """
   ...
   _____ _            __                  _   
  / ____| |          / _|                | |  
 | (___ | |__   __ _| |_ __ _  __ _  __ _| |_ 
  \___ \| '_ \ / _` |  _/ _` |/ _` |/ _` | __|
  ____) | | | | (_| | || (_| | (_| | (_| | |_ 
 |_____/|_| |_|\__,_|_| \__,_|\__, |\__,_|\__|
                                 | |          
                                 |_|          

\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: MuHammad Shafaqat
...
def main():
    ...
    print ' \033[0m[2].\x1b[1;96m Follow on YouTube '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://youtube.com/channel/UCm2--M6TEBlC7jHltkzlGdw')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
